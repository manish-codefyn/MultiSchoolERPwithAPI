...
SHARED_APPS = [
    ...
    "django_tenants",  # Must be first for WSGI/Tenants
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.communications.context_processors.unread_count",
                # OR use combined:
                # 'tenants.context_processors.combined_context',
            ],
            "libraries": {
                "core_tags": "templatetags.core_tags",
            },
        },
    },
]
...
COMPRESS_OFFLINE = True  # IMPORTANT
