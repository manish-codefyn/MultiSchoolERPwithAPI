...
class Notification(BaseModel):
    ...
    @property
    def sender(self):
        """Try to resolve sender from related object"""
        if self.related_object:
            if hasattr(self.related_object, 'sender'):
                return self.related_object.sender
            if hasattr(self.related_object, 'created_by'):
                return self.related_object.created_by
        return None
